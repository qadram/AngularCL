 ...
 * It inserts the headers needed to run the Phonegap API
 * It also checks sets the variable {$this->Name}Active to true if the Device can execute the PhoneGap API
