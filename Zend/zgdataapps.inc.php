...
class ZGDataApps extends Component
{
   ...
   /**
    * Getter for $_domain's default value.
    *
    ...
    * <ul>
    *   <li>service: Zend_Gdata_Gapps::AUTH_SERVICE_NAME.</li>
    *   <li>url: Zend_Gdata_Gapps::APPS_BASE_FEED_URI.</li>
    ...
    * initialize $_gapps with available data. If false is returned, $_gapps will be
    * set to null instead.
    *
    * @var      string
    */
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set but an error occurs during user creation, an string with the description of such an
    * error will be returned instead.
    *
    * If everything works, you will get an instance of Zend_Gdata_Gapps_UserEntry.
    *
    ...
    *                                           when calling this method, $passwordHashFunction,
    *                                           is set to 'SHA-1'.
    * @param    string  $passwordHashFunction   Optional. If $password is a SHA-1 digest
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false.
    *
    * Else, it will return a collection of all
    * users in the domain.
    *
    ...
    *
    * Else, it will return a collection of all
    * users in the domain from given user position, in alphabetical
    * order.
    *
    ...
    * Modifies user data.
    *
    * The following keys for key-value pairs are supported on the $params array:
    * <ul>
    *   <li>username: Login name (string).</li>
    *   <li>password: Password in plain text (string). It can also be a SHA-1 digest as
    *                        long as hash_function_name is set to 'SHA-1'.</li>
    *   <li>hash_function_name: Hash function used for password encryption, if any (string).</li>
    *   <li>administrator: Whether this user is an administrator or not (boolean).</li>
    *   <li>change_password_next_login: Whether or not user should be forced to change their
    *                                          password next time they log in (boolean).</li>
    *   <li>suspended: Whether user is suspended or not (boolean).</li>
    *   <li>name: First name (string).</li>
    *   <li>family_name: Last name (string).</li>
    *   <li>quota: Quota limit, in MB (string). For example: '120'.</li>
    * </ul>
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    ...
    * error will be returned instead.
    *
    * If everything works, you will get an instance of Zend_Gdata_Gapps_UserEntry for
    * modified user.
    *
    * @param    string  $username       User login name.
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_UserEntry
    * for modified user.
    *
    * @param    string  $username                       User login name.
    * @return   boolean|Zend_Gdata_Gapps_UserEntry
    ...
    * error will be returned instead.
    *
    * If everything works, you will get an instance of Zend_Gdata_Gapps_NicknameEntry for
    * given user.
    *
    * @param    string  $username       User login name.
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_NicknameEntry
    * for given nickname.
    *
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_NicknameFeed
    ...
    *
    * Else, it will return a collection of all
    * nicknames in the domain from given nickname position, in
    * alphabetical order.
    *
    * If no argument is passed, this method will return the same value as a call to
    ...
    *
    * If everything works, you will get an instance of Zend_Gdata_Gapps_EmailListEntry.
    *
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_EmailListFeed
    ...
    *
    * Else, it will return a collection of all
    * mailing lists in the domain from given mailing list
    ...
    *
    * If everything works, you will get an instance of Zend_Gdata_Gapps_EmailListRecipientEntry
    * for given recipient.
    *
    * @deprecated       Groups should be used instead.
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_EmailListRecipientFeed
    * containing recipients for given mailing list,
    ...
    *
    * Else, it will return a collection of all
    * recipients in the domain from given recipient
    * position, in alphabetical order.
    *
    * If $startRecipient argument is not passed, this method will return the same value as a
    * call to retrieveAllRecipients().
    *
    * @deprecated       Groups should be used instead.
   ...
   /**
    * Deletes Zend_Gdata_Gapps instance.
    *
    * Sets $_gapps to null.
    */
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_GroupEntry
    * for created group.
    *
    ...
    * 
    * If $_gapps is not set (is null) or given user or group is not member of given group,
    ...
    * If $_gapps is not set (is null), this method will return a boolean value, false. 
    *
    * If everything works, you will get an instance of Zend_Gdata_Gapps_MemberEntry for
    * given member.
    *
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_MemberFeed
    * containing members of given group, or null if group has
    * no members.
    *
    * @param    string  $groupId        Group identifier.
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_OwnerEntry
    * for given owner.
    *
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_OwnerFeed
    * containing owners of given group.
    *
    * @param    string  $groupId        Group identifier.
    ...
    * 
    * If $_gapps is not set (is null) or given email address does not belong to an owner of
    ...
    * 
    * If $_gapps is not set (is null), this method will return a boolean value, false. If it
    * is set and everything works, you will get an instance of Zend_Gdata_Gapps_GroupFeed
    ...
    *
    * Else, it will return a collection of all
    * groups in the domain from given group position, in
    * alphabetical order.
    *
    * If no argument is passed, this method will return the same value as a call to
    * retrieveAllGroups().
    ...
    *
    * Else, it will return a collection of all
    * members in the domain from given member position, in 
    * alphabetical order.
    *
    * If $startMember argument is not passed, this method will return the same value as a
    * call to retrieveAllMembers().
    *
    * @param    string  $groupId        Group identifier.
