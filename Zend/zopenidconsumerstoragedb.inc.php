...
/**
 * Subclass of Zend_OpenId_Consumer_Storage to ease its configuration.
 *
...
class OpenIdConsumerStorageDB extends Zend_OpenId_Consumer_Storage
{
    ...
    * @param    string          $association_table      Optional value for $_association_table,
    *                                                   it defaults to 'association'.
    * @param    string          $discovery_table        Optional value for $_discovery_table,
    *                                                   it defaults to 'discovery'.
    * @param    string          $nonce_table            Optional value for $_nonce_table,
    ...
    *
    * You must also pass by reference the other association variables, which will hold retrieved
    * data.
    *
    ...
    *
    * You must also pass by reference the other discovery variables, which will hold retrieved data.
    *
   ...
   /**
    * Removes data from $_nonce_table older than given date.
    *
...
/**
 * Interface to generate an instance of OpenIdConsumerStorageDB.
 *
 * @link        http://framework.zend.com/manual/en/zend.openid.consumer.html#zend.openid.consumer.storage Zend Framework Documentation
 */
class ZOpenIdConsumerStorageDB extends ZOpenIdConsumerStorage
{
   ...
   /**
   * Returns an instance of OpenIdConsumerStorageDB generated from provided settings.
   *
