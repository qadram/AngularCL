...
class ZGDataYoutube extends Component
{
   ...
   /**
    * Setter method for $_developerkey.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_developerkey's default value.
    *
    ...
    * <ul>
    *   <li>service: Zend_Gdata_YouTube::AUTH_SERVICE_NAME.</li>
    *   <li>url: 'http://gdata.youtube.com'.</li>
    ...
    * $_youtube using provided $_developerkey. If false is returned, 
    * $_youtube will also be initialized, but without the $_developerkey, which
    ...
    * criteria:
    * <ul>
    *   <li>author: Video uploader (string).</li>
    *   <li>format: Video format (integer). Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#Query_parameter_definitions)
    *   for additional information.</li>
    *   <li>location: Video location (string). Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#Query_parameter_definitions)
    *   for additional information.</li>
    *   <li>location_radius: Valid radius around given location (string). Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#Query_parameter_definitions)
    *   for additional information.</li>
    *   <li>max_results: Maximum amount of results to be retrieved (integer).</li>
    *   <li>order_by: How results should be ordered (string). Possible values are:
    *   'relevance', 'published', 'viewCount', or 'rating'.</li>
    *   <li>safe_search: Content restriction level (string). Possible values are: 'none',
    *   'moderate', or 'strict'.</li>
    *   <li>start_index: Index of the first result to be retrieved (integer). In combination
    *   with max_results, it can be used to paginate retrieved results.</li>
    *   <li>time: Time on which videos were uploaded (string). Possible values are: 'today',
    *   'this_week', 'this_month', or 'all_time'.</li>
    *   <li>query: Text to search for (string).</li>
    *   <li>category: Category and keywords to search for (string). It follows this syntax:
    *   'Category/keyword/keyword'.</li>
    * </ul>
    *
    * Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#Query_parameter_definitions)
    * for additional information.
    * 
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_VideoFeed
    * for matching videos.
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_PlaylistListFeed.
    *
    * @param    string  $username       Username.
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_PlaylistListEntry.
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_SubscriptionListFeed.
    *
    * @param    string  $username       Username.
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_UserProfileEntry.
    *
    * @param    string  $username       Username.
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Youtube_Extension_State.
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_VideoEntry.
    *
    * @param    string|Zend_Gdata_YouTube_VideoEntry    $id_video       Video identifier or object.
    ...
    * <ul>
    *   <li>title: Video title (string).</li>
    *   <li>description: Video description (string).</li>
    *   <li>category: Video category (string). Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#YouTube_Category_List)
    *   for a list of supported categories.</li>
    *   <li>tags: Comma-separated list of video tags (string).</li>
    *   <li>date_recorded: Date when video was recorded (string). Use the following date
    *   format: YYYYMMDD. For example, if a video was recorded in May 18th, 1991, value would be
    *   '19910518'.</li>
    *   <li>visibility: Video visibility (string). Possible values are 'public' or 'private'.</li>
    *   <li>position: Location where video was recorded (string). Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#Query_parameter_definitions)
    *   for additional information.</li>
    * </ul>
    * 
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    ...
    * Deletes a video.
    * 
    * If $_youtube is not set (is null), this method will return a boolean value, false. If
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_CommentFeed.
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_App_Entry for new comment.
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_App_Entry.
    *
    * @param    string|Zend_Gdata_YouTube_VideoEntry    $id_video               Video identifier or object.
    ...
    *
    * Given video must be obtained from a call to retrieveFavoritesVideosByUser(), which
    * will return an instance of Zend_Gdata_YouTube_VideoFeed from which you can get an
    * instance of Zend_Gdata_YouTube_VideoEntry.
    * 
    * If $_youtube is not set (is null), this method will return a boolean value, false. If
    * it is set, it will return nothing (void).
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_ContactFeed.
    *
    * @param    string  $username       Username.
    ...
    * @param    array|string    $category       New contact category or categories. Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#YouTube_Category_List)
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_ContactEntry.
    *
    ...
    *                                                                   categories.  Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#YouTube_Category_List)
    *                                                                   for a list of supported categories.
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_InboxFeed.
    *
    ...
    * If $_youtube is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_YouTube_ActivityFeed.
    *
    ...
    * criteria:
    * <ul>
    *   <li>filepath: File path (string).</li>
    *   <li>filetype: File MIME type (string).</li>
    *   <li>title: Video title (string).</li>
    *   <li>description: Video description (string).</li>
    *   <li>category: Video category (string). Check Google Documentation (http://code.google.com/apis/youtube/2.0/reference.html#YouTube_Category_List)
    *   for a list of supported categories.</li>
