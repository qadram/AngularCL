...
class ZGDataPhotos extends Component
{
    ...
    * <ul>
    *   <li>service: Zend_Gdata_Photos::AUTH_SERVICE_NAME.</li>
    *   <li>url: Zend_Gdata_Photos::PICASA_BASE_URI.</li>
    ...
    * $_photos and set $_visibility to 'private'. If false is returned,
    * $_photos will also be initialized, but $_visibility will be set to 'public'
    * instead.
    *
    * @var      string
    */
    ...
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Photos_UserFeed.
    *
    ...
    * <ul>
    *   <li>title: Album title (string).</li>
    *   <li>summary: Album description (string).</li>
    *   <li>location: Location where album photos were taken (string).</li>
    *   <li>access: Album visibility. Possible values are: 'all', 'public', or 'private'.</li>
    * </ul>
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Photos_AlbumEntry for your
    * new album.
    *
    ...
    * Deletes an album.
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false. If
    ...
    * have in common:
    * <ul>
    *   <li>album: Album name (string).</li>
    *   <li>id_album: Album identifier (string).</li>
    *   <li>user: Username for the user who uploaded the photos (string).</li>
    *   <li>access: Album visibility. Possible values are: 'all', 'public', or 'private'.</li>
    *   <li>imgMax: Image size (string). For a list of valid values, check Google Documentation (http://code.google.com/apis/picasaweb/docs/1.0/reference.html#Parameters).</li>
    *   <li>thumbsize: Thumbnail size (string). For a list of valid values, check Google Documentation (http://code.google.com/apis/picasaweb/docs/1.0/reference.html#Parameters).</li>
    *   <li>query: Full-text query string.</li>
    * </ul>
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Photos_Feed for matching
    * photos.
    *
    * @param    array   $params Parameters.
    ...
    * <ul>
    *   <li>filename: File path (string).</li>
    *   <li>filetype: File MIME type (string).</li>
    *   <li>title: Photo title (string).</li>
    *   <li>summary: Photo description (string).</li>
    *   <li>tags: Photo tags (string).</li>
    *   <li>position: Photo position (string).</li>
    *   <li>user: User who uploads the photo (string).</li>
    *   <li>id_album: Identifier of the album photo will be uploaded to (string).</li>
    *   <li>commentingEnabled: Whether or not comments will be allowed for the photo (boolean).</li>
    * </ul>
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Photos_PhotoEntry for your
    * new photo.
    *
    * @param    array   $params Parameters.
    ...
    * common:
    * <ul>
    *   <li>id_photo: Photo identifier (string).</li>
    *   <li>album_name: Album name (string).</li>
    *   <li>id_album: Album identifier (string).</li>
    *   <li>user: Username for the user who uploaded the photos (string).</li>
    * </ul>
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Photos_UserFeed for tags
    * on matching photos.
    *
    * @param    array   $params Parameters.
    * @return   boolean|Zend_Gdata_Photos_UserFeed
    ...
    * have in common:
    * <ul>
    *   <li>tags: Tags (string).</li>
    *   <li>user: Username for the user who uploaded the photos (string).</li>
    * </ul>
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Photos_UserFeed for
    * matching photos.
    *
    * @param    array   $params Parameters.
    * @return   boolean|Zend_Gdata_Photos_UserFeed
    ...
    *   <li>id_album: Album identifier (string).</li>
    *   <li>user: Username for the user who uploaded the photos (string).</li>
    *   <li>comments: Comments (array of strings).</li>
    * </ul>
    * 
    * If $_photos is not set (is null), this method will return a boolean value, false.
    *
