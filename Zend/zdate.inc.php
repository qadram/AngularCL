...
class ZDate extends Component
{
    ...
    * 
    * Expected date format is the one corresponding to the locale of the
    * object.
    *
    * @var      string
    */
    ...
    * Generator for $_date.
    *
    * Generates a Zend Framework Date object from those properties set for this
    * ZDate instance (or defaults), and saves it to $_date.
    */
   function CreateDate()
   {
   ...
   /**
    * Setter method for $_datedefaulttimezone.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_datedefaulttimezone's default value.
    *
    ...
    *
    * Possible values are: ftISO, or ftPHP.
    *
   ...
   /**
    * Getter for $_formattype's default value.
    *
    * @return   string  ftPHP
    */
   ...
   /**
    * Getter for $_fixdst's default value.
    *
   ...
   /**
    * Setter method for $_extendmonth.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_extendmonth's default value.
    *
   ...
   /**
    * Getter for $_datelocale's default value.
    *
    * @return   string  dlEN
    */
    ...
    *
    * @param    string  $part   Zend_Date constants (http://framework.zend.com/manual/en/zend.date.constants.html).
    * @param    string  $locale Locale. Possible values are the same as for $_datelocale.
    * @param    string  $format String defining date output format, either in
    *                           ISO (http://framework.zend.com/manual/en/zend.date.constants.html#zend.date.constants.selfdefinedformats)
    *                           or
    *                           PHP (http://framework.zend.com/manual/en/zend.date.constants.html#zend.date.constants.phpformats)
    *                           notation.
    * @param    string  $type   Date format type. Possible values are the same as for $_formattype.
    * @return   string
   */
    ...
    *
    * <ul>
    *   <li>When both dates are the same, it returns 0.</li>
    *   <li>When object date is more recent, it returns 1.</li>
    *   <li>When given date is more recent, it returns -1.</li>
    * </ul>
    *
   ...
   /**
    * Returns a Zend_Date object setup with today's date.
    *
    * @param    string          $locale Locale. Possible values are the same as for DateLocale.
    * @return   Zend_Date
    */
    ...
    *       <li>astronomical</li>
    *       <li>civic</li>
    *       <li>effective (default)</li>
    *       <li>nautic</li>
    *     </ul>
    *   </li>
    *   <li>longitude: longitude of the location.</li>
    *   <li>latitude: latitude of the location.</li>
    * </ul>
    *
