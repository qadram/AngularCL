...
/**
* Base class for adapters to be used for ZAuth::$_authadapter.
*
* {@internal Adapters inherit from this class, which provides a method to authenticate, which is
* called by ZAuth with the appropiated parameters, to know if the specifier user has been
...
class ZAuthAdapter extends Component
{
    ...
    *
    * @param    Zend_Auth       $auth           Zend Framework Authentication component used for authentication.
