...
/**
 * Interface to generate an instance of Zend_OpenId_Provider_Storage_File.
 */
class ZOpenIdProviderStorageFile extends ZOpenIdProviderStorage
{
   ...
   /**
    * Guesses a temporal-folder path and setups $_destinationpath with it.
    */
    ...
    *
    * If no value is provided for this property, a temporal folder will be
    * used instead.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_destinationpath.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_destinationpath's default value.
    *
   ...
   /**
    * Returns an instance of Zend_OpenId_Provider_Storage_File generated from provided settings.
    *
