...
class ZJson extends Component
{
   ...
   /**
    * Setter method for $_encoderdecoder.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_encoderdecoder's default value.
    *
    * @return   string  edPHP
    */
    ...
    * this by setting $options['enableJsonExprFinder'] = true.
    *
    * Use 'indent' option to select indentation string - by default it's a tab. Set
    * $optionsPretty['indent'] to use.
    *
