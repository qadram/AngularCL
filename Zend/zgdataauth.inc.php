...
class ZGDataAuth extends Component
{
   ...
   /**
    * Setter method for $_googleemail.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_googleemail's default value.
    *
   ...
   /**
    * Setter method for $_googlepassword.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_googlepassword's default value.
    *
    * @return   string  Empty string
    */
   ...
   /**
    * Setter method for $_useclientlogin.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_useclientlogin's default value.
    *
   ...
   /**
    * Setter method for $_urlredirect.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_urlredirect's default value.
    *
    * @return   string  Empty string
    */
    ...
    * CAPTCHA token.
    *
    * Might be used when working with ClientLogin.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_captchatoken.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_captchatoken's default value.
    *
    * @return   string  Null
    */
   ...
   /**
    * Setter method for $_captchastring.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_captchastring's default value.
    *
    * @return   string  Null
    */
    ...
    * <ul>
    *   <li>service: Google service (string).</li>
    *   <li>url: Service authentication URL (string).</li>
    *   <li>appname: Name of your application (string).</li>
    * </ul>
    *
    * If main and session tokens are not set, authentication
    * URL will be returned.
    *
    * If tokens are set but authentication fails, a boolean value will be returned, false.
    *
    * If tokens are set and authentication is successful, an instance of Zend_Gdata_HttpClient
    * will be returned.
    *
    ...
    *
    * Should be only when not working with ClientLogin.
    *
    * This will return false if component owner is not set.
    *
    * @return   boolean
    */
