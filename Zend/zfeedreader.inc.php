...
class ZFeedReader extends Component
{
   ...
   /**
    * Getter for $_sourcetype's default value.
    *
    * @return   string  stURL
    */
    ...
    * Source URL.
    *
    * Ignored unless $_sourcetype is set ot stURL.
    *
    * @var      string
    */
   ...
   /**
    * Getter for $_sourceurl's default value.
    *
    ...
    * Source file path.
    *
    * Ignored unless $_sourcetype is set ot stFile.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_sourcefilename.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_sourcefilename's default value.
    *
    * @return   string  Empty string
    */
    ...
    * Source string.
    *
    * Ignored unless $_sourcetype is set ot stString.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_sourcestring.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_sourcestring's default value.
    *
    * @return   string  Empty string
    */
    ...
    * Generator for $_feed.
    *
    * Generates a Zend Framework Feed Reader object from those properties
    * set for this ZFeedReader instance (or defaults), and saves it to $_feed.
    */
   function createFeed()
   {
   ...
   /**
    * Returns the ISO 639-1 code (http://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for
    ...
    *
    * The type will be a static class constant, such as Zend_Feed_Reader::TYPE_ATOM_03 if
    * feed is Atom version 3. For a list of these constants, check
    * Zend Framework API Documentation (http://framework.zend.com/apidoc/core/).
    *
    * @return   integer
    */
   ...
   /**
    * Returns a Zend_Feed_Reader_Collection_Category object containing the details of any
