...
class ZGDataBooks extends Component
{
    ...
    * <ul>
    *   <li>service: Zend_Gdata_Books::AUTH_SERVICE_NAME.</li>
    *   <li>url: Zend_Gdata_Books::VOLUME_FEED_URI.</li>
    ...
    * $_books and set $_visibility to 'private'. If false is returned, $_books
    * will also be initialized, but $_visibility will be set to 'public' instead.
    *
    * @var      string
    */
    ...
    * <ul>
    *   <li>user: User identifier (string) whose collection will be searched.</li>
    *   <li>search: Text to look for (string).</li>
    *   <li>minViewability: Book visibility level (string). It can be set to 'none',
    *                              'partial_view' or 'full_view'.</li>
    *   <li>startIndex: Position of the result in the search that should be first in returned
    *                          results (integer). All results before it in the search will be skipped in
    *                          returned results.</li>
    *   <li>maxResults: Maximum amount of results to be returned.</li>
    * </ul>
    *
    * If $_books is not set (is null), this method will return a boolean value, false.
    *
    * Else, it will return a collection of matching
    * volumes.
    *
    ...
    * If $_books is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Books_VolumeEntry for
    * rated book.
    *
    ...
    *
    * If $_books is not set (is null), this method will return a boolean value, false. If it
