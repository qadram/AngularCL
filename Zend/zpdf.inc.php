...
class ZPdf extends Component
{
   ...
   /**
    * Getter for $_author's default value.
    *
    * @return   string  Empty string
    */
   ...
   /**
    * Getter for $_keywords's default value.
    *
    * @return   string  Empty string
    */
   ...
   /**
    * Getter for $_creator's default value.
    *
    * @return   string  Empty string
    */
   ...
   /**
    * Getter for $_producer's default value.
    *
    * @return   string  Empty string
    */
   ...
   /**
    * Getter for $_trapped's default value.
    *
   ...
   /**
    * Setter method for $_stylefillcolor.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_stylefillcolor's default value.
    *
    * @return   string  Empty string
    */
   function defaultStyleFillColor()    {return '#000000';}
   ...
   /**
    * Setter method for $_stylelinecolor.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_stylelinecolor's default value.
    *
    * @return   string  Empty string
    */
   function defaultStyleLineColor()    {return '#000000';}
   ...
   /**
    * Setter method for $_stylelinewidth.
    *
    * @param    integer $value
    */
   ...
   /**
    * Getter for $_stylelinewidth's default value.
    *
    * @return   integer 2
    */
    ...
    *
    * It's an array of numeric values. You can generate it with an array() call following
    * this syntax:
    *
    * <code>
    ...
    * PDF document font.
    *
    * Possible values are: fnCourier, fnCourierBold, fnCourierBoldItalic,
    * fnCourierItalic, fnHelvetica, fnHelveticaBold,
    * fnHelveticaBoldItalic, fnHelveticaItalic, fnSymbol, fnTimes,
    * fnTimesBold, fnTimesBoldItalic, fnTimesItalic, or
    * fnZapfdingbats.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_stylefontname.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_stylefontname's default value.
    *
    * @return   string  fnCourier
    */
   ...
   /**
    * Setter method for $_stylefontsize.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_stylefontsize's default value.
    *
   ...
   /**
    * Generates an style object with defined settings, and gives $_style that value.
    *
    * @internal
    */
    ...
    *
    * {@internal Generator for both $_pdf and $_style.}}
    */
   function createPdf()
   {
    ...
    *
    * This method is equivalent to createPdf(), only that it lets you define the initial PDF
    * file to work with.
    *
    ...
    *                                           (psA4, psA4Landscape,
    *                                           psLetter, or psLetterLandscape), or
   ...
   /**
    * Creates a color from a web color (http://en.wikipedia.org/wiki/Web_colors).
    *
    ...
    *                                   <ul>
    *                                     <li>Zend_Pdf_Page::SHAPE_DRAW_FILL_AND_STROKE: Affects both rectangle fill and stroke.</li>
    *                                     <li>Zend_Pdf_Page::SHAPE_DRAW_STROKE: Affects only rectangle stroke.</li>
    *                                     <li>Zend_Pdf_Page::SHAPE_DRAW_FILL: Affects only rectangle fill.</li>
    *                                   </ul>
    */
    ...
    *                                           <ul>
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_FILL_AND_STROKE: Affects both polygon fill and stroke.</li>
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_STROKE: Affects only polygon stroke.</li>
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_FILL: Affects only polygon fill.</li>
    *                                           </ul>
    ...
    *                                           <ul>
    *                                             <li>Zend_Pdf_Page::FILL_METHOD_NON_ZERO_WINDING: Non-zero winding method.</li>
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_STROKE: Even-odd method.</li>
    *                                           </ul>
    */
    ...
    * @param    integer         $param4         Optional. As $fillType, you can select
    ...
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_FILL: Affects only polygon fill.</li>
    *                                           </ul>
    *                                           As $startAngle, it should be start angle in radians.
    ...
    * @param    float           $x2             X coordinate for the bottom-right point of the rectangle.
    * @param    float           $y2             Y coordinate for the bottom-right point of the rectangle.
    * @param    integer         $param5         Optional. As $fillType, you can select
    *                                           any of the following fill types:
    *                                           <ul>
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_FILL_AND_STROKE: Affects both polygon fill and stroke.</li>
    *                                             <li>Zend_Pdf_Page::SHAPE_DRAW_STROKE: Affects only polygon stroke.</li>
   ...
   /**
    * Restore the graphics state previously saved with the last call to saveGS().
    *
    * @param    integer $indexPage      Number of the page.
    */
