...
class ZRegistry extends Component
{
   ...
   /**
    * Type of registry toArray() should return.
    *
    * Possible values are trArray and trObject.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_typeregistry.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_typeregistry's default value.
    *
    * @return   string  trArray
    */
   ...
   /**
    * Returns registry values as an array or an object, depending on $_typeregistry value.
    *
    * @return   array|Object
    */
   function toArray()
