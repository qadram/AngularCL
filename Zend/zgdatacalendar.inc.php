 ...
 * it is often much larger than the pcFull projection. 
 * 
 * @const       pcComposite
 */
...
class ZGDataCalendar extends Component
{
    ...
    * <ul>
    *   <li>service: Zend_Gdata_Calendar::AUTH_SERVICE_NAME.</li>
    *   <li>url: Zend_Gdata_Calendar::CALENDAR_FEED_URI.</li>
    ...
    * $_calendar and set $_visibility to 'private'. If false is returned,
    * $_calendar will also be initialized, but $_visibility will be set to 'public'
    * instead.
    *
    * @var      string
    */
   ...
   /**
    * Setter method for $_projectioncalendar.
    *
    * @param    string  $value
    */
   ...
   /**
    * Getter for $_projectioncalendar's default value.
    *
    ...
    * 
    * If $_calendar is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Calendar_ListFeed for
    * user calendars.
    *
    ...
    *
    * You must pass the call an array as first argument, $params. You can add some kay-value
    * pairs to that array. You can find those on Google Documentation (http://code.google.com/apis/calendar/data/1.0/reference.html#Parameters).
    * For those properties with '-' character as separator, use '_' instead. For example, use
    * 'start_min' instead of 'start-min'.
    * 
    * If $_calendar is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get a collection of
    * events for given calendar.
    *
    ...
    * If $_calendar is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Calendar_EventEntry for
    * requested event.
    *
   ...
   /**
    * Generator for $_calendar.
    *
    * Generates a Zend Framework Google Calendar from those properties set for this
    * ZGDataCalendar instance (or defaults), and saves it to $_calendar.
    *
    * This method will not work unless user is properly authenticated.
    *
    ...
    *   <li>summary: Calendar description.</li>
    *   <li>where: Calendar location.</li>
    *   <li>timezone: Calendar timezone.</li>
    *   <li>hidden: Whether calendar should be hidden or not.</li>
    *   <li>color: Calendar color. See Google Documentation (http://code.google.com/apis/calendar/data/1.0/reference.html#Calendar_feeds)
    *                     for a list of available colors.</li>
    * </ul>
    * 
    * If $_calendar is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Calendar_EventEntry.
    *
    ...
    * Deletes a calendar.
    * 
    * If $_calendar is not set (is null), this method will return a boolean value, false. If
    ...
    * Only parameter is a key-value array with the following optional pairs:
    * <ul>
    *   <li>calendar: Calendar identifier.</li>
    *   <li>title: Event title.</li>
    *   <li>content: Long description of the event.</li>
    ...
    *   <li>tzOffset: Event timezone.</li>
    *   <li>eventStatus: Event status. Possible values are: 'canceled', 'confirmed', or 'tentative'.</li>
    *   <li>transparency: Event transparency. Possible values are: 'opaque' or 'transparent'.</li>
    *   <li>visibility: Event visibility. Possible values are: 'confidential', 'default', 'private', or 'public'.</li>
    *   <li>recurrence: Event recurrence. See Google Documentation (http://code.google.com/apis/gdata/docs/1.0/elements.html#gdRecurrence).</li>
    *   <li>reminders: Array of event reminders, each of which is also an array with the following key-value pairs:
    *     <ul>
    *       <li>method: Reminder method. Possible values are: 'sms', 'alert', or 'email'.</li>
    *       <li>absolutTime: Reminder time.</li>
    *       <li>minutes: Reminder time in minutes before the start of the event.</li>
    *     </ul>
    *   </li>
    *   <li>webcontent: Array with the folowwing key-value pairs:
    *     <ul>
    *       <li>url: URL to the content of the pop-up window.</li>
    *       <li>height: Pop-up window height.</li>
    *       <li>width: Pop-up window width.</li>
    ...
    * Second parameter is a key-value array with the following optional pairs:
    * <ul>
    *   <li>calendar: Calendar Post URL (e.g. "http://www.google.com/calendar/feeds/39jcl8esvhoi1vpt5fvkgurj60%40group.calendar.google.com/private/full").</li>
    *   <li>title: Event title.</li>
    *   <li>where: Event location.</li>
    *   <li>startDate: Event start date.</li>
    *   <li>startTime: Event start time.</li>
    ...
    * If $_calendar is not set (is null), this method will return a boolean value, false.
    *
    * If everything works, you will get an instance of Zend_Gdata_Feed for event comments.
    *
    * @param    string  $id_event       Event identifier.
